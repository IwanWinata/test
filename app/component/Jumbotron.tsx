					...
					{ItemContext.languages === 'indonesia' ? (
						<>
							...
							<Typography
								...
								Punya tanah kosong yang belum dimanfaatkan secara optimal? Atau mau jual tanah tapi gak laku-laku?
							</Typography>
						</>
					) : (
						<>
							...
							<Typography
								...
								Amani revolutionizes homeownership by offering innovative financial services that are designed to provide more
								accessible, affordable, and sharia-compliant solutions
							</Typography>
						</>
					)}
					<Button
						...
						<Typography
							...
							{ItemContext.languages === 'indonesia' ? 'Pelajari Lebih Lanjut' : 'Learn More'}
						</Typography>
						<ArrowForwardIcon />
					</Button>
				</div>
