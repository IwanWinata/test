...
export const AlertSuccess: React.FC<props> = ({ open, title, subTitle, onClose, duration }) => {
	useEffect(() => {
...
export const AlertFailed: React.FC<props> = ({ open, title, subTitle, onClose, duration }) => {
	useEffect(() => {
		let timer: NodeJS.Timeout;
